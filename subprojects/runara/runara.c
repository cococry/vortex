...
shader_prg_create(const char* vert_src, const char* frag_src) {
  ...
  //  vertex & fragment shader with the shader API
...
renderer_init(RnState* state) {
  ...
  const char* frag_src =
    ...
    "\n"
    "vec4 sample_texture(int idx, vec2 uv)\n"
    "{\n"
    "    switch (idx) {\n"
    "        case 1:  return texture(u_textures[0], uv);\n"
    "        case 2:  return texture(u_textures[1], uv);\n"
    "        case 3:  return texture(u_textures[2], uv);\n"
    "        case 4:  return texture(u_textures[3], uv);\n"
    "        case 5:  return texture(u_textures[4], uv);\n"
    "        case 6:  return texture(u_textures[5], uv);\n"
    "        case 7:  return texture(u_textures[6], uv);\n"
    "        case 8:  return texture(u_textures[7], uv);\n"
    "        case 9:  return texture(u_textures[8], uv);\n"
    "        case 10: return texture(u_textures[9], uv);\n"
    "        case 11: return texture(u_textures[10], uv);\n"
    "        case 12: return texture(u_textures[11], uv);\n"
    "        case 13: return texture(u_textures[12], uv);\n"
    "        case 14: return texture(u_textures[13], uv);\n"
    "        case 15: return texture(u_textures[14], uv);\n"
    ...
    "\n"
    "    if (v_tex_index != 0) {\n"
    "        col *= sample_texture(clamp(v_tex_index, 1, 31), v_texcoord);\n"
    "    }\n"
    "\n"
    "    o_color = col;\n"
    "}\n";
